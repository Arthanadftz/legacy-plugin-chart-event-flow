  ...
  controlPanelSections: [{
    ...
    controlSetRows: [['entity'], [{
      ...
      config: {
        ...
        description: t('Important! Select this if the table is not already sorted by entity id, ' + 'else there is no guarantee that all events for each entity are returned.'),
        default: true
      }
    }], [{
      ...
      config: {
        ...
        description: t('Leaf nodes that represent fewer than this number of events will be initially ' + 'hidden in the visualization')
      }
    }]]
  }, {
    label: t('Query'),
